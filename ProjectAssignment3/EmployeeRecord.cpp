 ...
 * Author: Paul Abers
 * Assignment 3: Employee Record Class
 *
...
void EmployeeRecord::removeCustomerList() { //remove customer list
    m_pCustomerList = NULL;
}

void EmployeeRecord::destroyCustomerList() { //destroy customer list
    if (m_pCustomerList != NULL) { //do nothing, already null
        delete m_pCustomerList;
        m_pCustomerList = NULL;
    }
}
